...
import { listPendingInvitationsForUser } from "@/lib/invitation";
...
/** Pending invitations addressed to the caller's own account email. */
export async function GET(request: Request): Promise<NextResponse> {
  ...
  try {
    ...
    console.error("unexpected error handling GET /api/v1/invitations/mine", error);
